...
public class ASternTest {
    ...
    public void testcase1() {
        ...
        final Node[] weg = a.computeShortestPath();

        // TODO - remove
        /*
        Graph g = new Graph("src/main/java/astern/ortschaften-demo.csv", 10000);
        Weg weg = g.aStern(0, 1);
        Weg weg2 = g.aStern(999, 109);
        double laenge = weg.getLaenge();
        weg.toString();
        ...
        */
        ...
        assertEquals(84681, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase2() {
        ...
        assertEquals(94180, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase3() {
        ...
        assertEquals(72351, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase4() {
        ...
        assertEquals(139166, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase5() {
        ...
        for(final Node node : weg) {
            wegString.append(node.getIndex()).append(" ");
        }
        assertEquals("20 4920 505 ", wegString.toString());
        assertEquals(13414, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase6() {
        ...
        assertEquals(61726, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase7() {
        ...
        assertEquals(68327, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase8() {
        ...
        assertEquals(81102, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase9() {
        ...
        assertEquals(95552, AStern.getPathLength(weg), 0.99999999999);
    }
    ...
    public void testcase11() {
        ...
        assertEquals(25603, AStern.getPathLength(weg), 0.99999999999);
    }
}
